  	...
  	this.english = [
        ...
        url: "#"
  		...
  		],
  		{
  			contact: {
  				title: "ありがとうございました！",
  				line1: "I am planning to make my career jump in March 2018. As a United States citizen, I, of course, can work and am open to working in the US. Since I am in Japan at the moment, however, I would like to find work in Tokyo.",
  				line2: "Feel free to reach out to me to request my resume or ask any questions you like. I am very open to suggestions and constructive feedback. I want to improve as much as I can in all areas.",
  				line3: "As we say in Japan: よろしくお願いします。 I hope for a good relationship with you."
  			}
  		}
  	]
        ...
        vlink: "http://placehold.it/586x327",
  		...
  		],
  		{
  			contact: {
  				...
  				line1: "3月2018年にキャリアの変更をするつもりです。私はアメリカ人ですからアメリカに働くこともちろんできます。でも今日本に住んでいますから東京に働きたいです。",
  				line2: "私の履歴書を見て質問を聞くためにいつでも私に連絡してください。私が皆さんの手応えも聞きたいです。このに私は新しいですけど上手になりたいです。",
  				line3: "よろしくお願いします。 Or English: I hope for a good relationship with you."
  			}
  		}
  	]
  }
  getData(language){
  	const data = this[language].slice()
  	return data
  }

}

const languageData = new DataStore()
